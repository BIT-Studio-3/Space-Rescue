...
public class PlanetRotate : MonoBehaviour
{
    ...
    private const float MINSPEED = 0.75f; //The min speed the planet can orbit at
    private const float MAXSPEED = 2f; //This + 1 is the max speed the planet can rotate at
